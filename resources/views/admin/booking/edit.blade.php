...
<div class="container">
    ...
    <form action="{{ route('booking.update', $booking->id) }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" name="nama" value="{{ old('nama', $booking->nama) }}" class="form-control" required>
        </div>

        <div class="form-group">
            <label for="no_tlp">No. Telepon</label>
            <input type="text" name="no_tlp" value="{{ old('no_tlp', $booking->no_tlp) }}" class="form-control" required>
        </div>

        <div class="form-group">
            <label for="email">Email</label>
            <input type="email" name="email" value="{{ old('email', $booking->email) }}" class="form-control" required>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" name="waktu" value="{{ old('waktu', $booking->waktu) }}" class="form-control" required>
        </div>

        <div class="form-group">
            <label for="note">Catatan</label>
            <textarea name="note" class="form-control">{{ old('note', $booking->note) }}</textarea>
        </div>
