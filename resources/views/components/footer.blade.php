        ...
        <div class="container">
            <div class="footer-container">
                ...
                <div class="footer-section">
                    <h3>Layanan</h3>
                    <ul>
                        <li><a href="#services">Potong & Styling Rambut</a></li>
                        <li><a href="#services">Pewarnaan Rambut</a></li>
                        <li><a href="#services">Perawatan Wajah</a></li>
                        <li><a href="#services">Nail Art & Manicure</a></li>
                        <li><a href="#services">Body Massage</a></li>
                        <li><a href="#services">Makeup Profesional</a></li>
                    </ul>
                </div>
                <div class="footer-section">
            ...
            <div class="footer-bottom">
                <p>&copy; 2025 Twin Glow Beauty Salon. All Rights Reserved.</p>
            </div>
        </div>
    </footer>   